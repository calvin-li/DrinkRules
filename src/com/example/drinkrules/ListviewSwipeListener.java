 ...
 * ensure that this {@link ListviewSwipeListener} is paused during list view
 * scrolling.</p>
 *
 * <p>Example usage:</p>
 *
...
public class ListviewSwipeListener implements View.OnTouchListener {
    ...
    /**
     * The callback interface used by {@link ListviewSwipeListener} to inform its client
     ...
     */
    public ListviewSwipeListener(ListView listView, OnDismissCallback callback) {
     ...
     * {@link ListviewSwipeListener} is paused during list view scrolling.</p>
     *
     * @see {@link ListviewSwipeListener}
     */
